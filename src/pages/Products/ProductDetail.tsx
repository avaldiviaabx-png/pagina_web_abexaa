...
const ProductDetail = () => {
  ...
  const handleWhatsApp = () => {
    const message = `Hola, estoy interesado en ${product.name}.¿Podrían brindarme más información, por favor?`;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="p-8">
              ...
              <button
                ...
                className="w-full py-4 bg-white shadow-lg hover:bg-green-300 text-green-600 rounded-xl flex items-center justify-center space-x-2 transition-colors"
              >

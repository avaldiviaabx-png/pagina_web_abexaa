  ...
  return (
    <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 h-full flex flex-col">
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <p className="text-gray-900 mb-4 font-light">{description}</p>
        <div className="mt-auto">
          <button
            onClick={() => navigate(`/products/${id}`)}
            className="px-4 py-2 w-full bg-gradient-to-r from-blue-800 to-blue-500 text-white rounded hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-300 active:bg-indigo-700 transition"
          >
            Ver detalles
          </button>
        </div>
